...
<div class="w-50 m-auto">
  ...
  <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 w-100">
    @auth
    ...
    <div class="d-flex justify-content-end align-items-center mb-3 ms-auto">
      <form class="input-group" method="get" action="/student/all">
      ...
      <div class="dropdown ms-2">
        ...
        <ul class="dropdown-menu">
          ...
          @foreach ($kelas as $item)
            <li><a class="dropdown-item" href="{{ route('filter', $item->id) }}">{{ $item->nama }}</a></li>
          @endforeach
        </ul>
      </div>
    </div>
      ...
      @foreach($students as $student)
        <tr>
          ...
          <td class="text-center">
            <a type="button" class="btn btn-info mx-1" href="/student/detail/{{ $student->id }}">Detail</a>

            @auth

            <a type="button" class="btn btn-warning mx-1" href="/student/edit/{{ $student->id }}">Edit</a>
